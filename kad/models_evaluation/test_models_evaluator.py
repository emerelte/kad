...
class TestFirstScoringComponent(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        preprocessed_df[GROUND_TRUTH_COLUMN] = [idx in ground_true_anomalies_df.index for idx in original_df.index.tolist()]
